...
class DesktopSettingPage extends StatefulWidget {
  ...
  static final List<SettingsTabKey> tabKeys = [
    if (!bind.isDisableSettings()) SettingsTabKey.general,
    if (!isWeb &&
        !bind.isOutgoingOnly() &&
        (!bind.isDisableSettings() || bind.isIncomingOnly()) &&
    ...
    if (!bind.isDisableAccount() && !bind.isDisableSettings())
        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://ndmais.com.br');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Grupo ND\n$license',
